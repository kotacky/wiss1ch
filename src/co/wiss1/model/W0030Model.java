...
public class W0030Model {
	...
	//カテゴリの追加
	public static int insertCategory(String categoryName, String parentId, String userId, Object categoryid, String checkBox) {
		//初期化
		...
		try {
			...
			if (categoryid != null){
				...
				insertSql = "UPDATE t_category SET  category_name ='" + categoryName + "' , update_date = current_timestamp , update_user ='" + userId +"'  WHERE  category_id = '"+ checkBox +"';";
			}
